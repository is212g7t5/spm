...
@router.get("/all", response_model=List[schemas.Job_Skill])
...
@router.get("/{job_id}&{skill_id}", response_model=schemas.Job_Skill)
...
@router.post("", response_model=schemas.Job_Skill)
...
@router.put("/{job_id}&{skill_id}", response_model=schemas.Job_Skill)
...
@router.delete("/{job_id}&{skill_id}", response_model=schemas.Job_Skill)
