...
function DeactivateSkillModal({
  ...
  return (
    <div
      className='fixed top-0 left-0 h-screen w-screen scale-100 backdrop-grayscale backdrop-blur-3xl z-8'
      aria-hidden='true'
    ...
    >
      ...
      >
        ...
        <div className='py-1 flex justify-end'>
          <button
            type='button'
            className='text-white bg-primary hover:bg-secondary font-medium rounded-lg text-sm px-5 py-2.5 mx-2'
