...
function LearningJourneyTile({ learningId, jobName, jobDesc, isJobActive }) {
  ...
  return (
    <div className="max-w-sm bg-white rounded-lg border border-gray-100 hover:bg-gray-100 hover:shadow-lg hover:shadow-cyan-200 mt-10">
      <div className="flex justify-end px-4 pt-4">
        <button id="dropdownButton" data-dropdown-toggle="dropdown" className="inline-block text-gray-500 hover:bg-white rounded-lg text-sm p-1.5" type="button">
        ...
        <div id="dropdown" className="hidden z-10 w-44 text-base list-none bg-white rounded divide-y divide-gray-100">
