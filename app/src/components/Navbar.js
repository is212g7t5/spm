          ...
          <div className="flex h-16 justify-between mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex">
              ...
              <div className="flex flex-shrink-0 items-center">
                <a href="/" className="text-lg font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-white">LJPS</a>
              </div>
                  ...
                  <div>
                    <Menu.Button className="flex rounded-full bg-cyan-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-cyan-800">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path fill="white" stroke="white" strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                      </svg>
                    </Menu.Button>
                  </div>
                  <Transition
