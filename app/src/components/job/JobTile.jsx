...
function CreateEditJobButton({ handleEditJobButtonClick }) {
  return (
    <button
      type='button'
      className='w-full flex items-center justify-center ml-auto text-textColor bg-secondary hover:bg-tertiary focus:ring-4 rounded-lg text-sm px-5 py-2.5 text-center m-1'
