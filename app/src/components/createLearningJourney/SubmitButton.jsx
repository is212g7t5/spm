    ...
    <div className="flex-shrink-0 items-center mt-5 mr-auto">
      {
        Object.keys(selectedCourseDetails).length === 0
          ? <button disabled className="relative inline-flex items-center rounded-md border border-transparent text-white bg-gray-300 hover:bg-gray-400 cursor-not-allowed bg-grey-500 px-4 py-2 text-sm font-medium shadow-sm" type="submit">
            Disabled
          </button>
          : <button 
