...
export default function SubmitButton({ isEditing, createLJ, updateLJ }) {
  ...
  const buttonClassNames = isDisabled
    ...
    : "relative inline-flex items-center rounded-md border border-transparent bg-accent2 hover:bg-accent3 px-4 py-2 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500";
