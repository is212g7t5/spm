        ...
        <div className="max-w-sm pl-12 pt-3">
            ...
            <form className="flex items-center">
                <div className="relative w-full">
                    ...
                    <input type="text" id="simple-search" className="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-cyan-500 dark:focus:border-cyan-500" placeholder={searchBarPlaceholder} required />
                </div>
